...
final case class Account(
    ...
    currencyId: String, // TODO Newtype
    currencyCode: String,
    currencySymbol: String,
    currencyDecimalPlaces: Int,
    currencyBalance: String,
    currencyBalanceDate: LocalDate,
  ...
  given Decoder[Account] = new Decoder[Account]:
    final def apply(c: HCursor): Decoder.Result[Account] =
      (
        ...
        c.downField("currencyId").as[String],
        c.downField("currencyCode").as[String],
        c.downField("currencySymbol").as[String],
        c.downField("currencyDecimalPlaces").as[Int],
        c.downField("currencyBalance").as[String],
        c.downField("currencyBalanceDate").as[LocalDate],
        ...
        c.downField("virtualBalance").as[String],
